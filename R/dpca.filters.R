...
#' @param thresh a numerical number in \eqn{(0,1)}. Can be provided alternatively to \eqn{q}. The closer to 1, the more filter coefficients will be computed.
#' @return An object of class \code{timedom}.  The list has the following components:
#' * \code{operators} an array. Each matrix in this array has dimension \eqn{Ndpc \times d} and is assigned to a certain lag. For a given lag \eqn{k}, the rows of the matrix correpsond to \eqn{\phi_{\ell k}^\prime}.
