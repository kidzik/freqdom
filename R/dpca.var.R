...
#' 
#' Consider a spectral density matrix \eqn{\mathcal{F}_\omega} and let \eqn{\lambda_\ell(\omega)} by the \eqn{\ell}-th dynamic eigenvalue. The proportion of variance described by the \eqn{\ell}-th dynamic principal component is given as \eqn{v_\ell:=\int_{-\pi}^\pi \lambda_\ell(\omega)d\omega/\int_{-\pi}^\pi \mathrm{tr}(\mathcal{F}_\omega)d\omega}. This function numerically computes the vectors \eqn{(v_\ell\colon 1\leq \ell\leq d)} and \eqn{\big(\sum_{j=1}^\ell v_j\colon 1\leq \ell\leq d\big)}.
#'
...
#' @seealso \code{\link{dpca.scores}}, \code{\link{dpca.filters}}
